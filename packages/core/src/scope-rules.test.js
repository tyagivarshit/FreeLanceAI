...
import { ScopeExtraction, ScopeFact, ScopeFactType, ScopeFactValue, ScopeSourceReference, ScopeEvidence, } from "./scope-extraction.js";
import { ScopeRuleType, ScopeRule, ScopeRuleSet, ScopeDecision, ScopeDecisionValue, ScopeRuleViolation, ScopeEvaluation, ScopeEvaluationCompletedEvent, ScopeRulesEngine, } from "./scope-rules.js";
describe("Scope Rules Domain and Boundary Tests", () => {
    ...
    test("Rule creation, type validation and immutability", () => {
        ...
        assert.throws(() => {
            rule.parameters.requiredType = "EXCLUSION";
        }, TypeError);
    });
    ...
    test("Scope rule violation parameters immutability", () => {
        ...
        assert.throws(() => {
            violation.relatedReferences.push("ref-2");
        }, TypeError);
    });
