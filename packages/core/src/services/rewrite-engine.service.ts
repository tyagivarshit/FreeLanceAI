...
export class ReplyRewriteEngineService {
   ...
   */
  private async validateStrictIntersection(tenantId: string, clientId: string, documentId?: string): Promise<boolean> {
   ...
   */
  async enqueueTextRewrite(request: TextRewriteRequest): Promise<string> {
   ...
   */
  public async processRewriteStream(jobId: string, request: TextRewriteRequest) {
