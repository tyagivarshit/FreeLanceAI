...
import { ExplanationPolicy } from "./job-match-explanation.js";
// =================================================--------------------
...
describe("Chapter 8I — Job Matching Worker Layer Tests", () => {
    ...
    test("16. Duplicate execution protection", async () => {
        ...
        await store.complete("work-1", "tenant-1", "worker-2", claimedItem.leaseId, claimedItem.fencingToken, { jobMatchId: "match-finished" });
        const item = JobMatchWorkItem.create({
            workItemId: "work-1",
            tenantId: "tenant-1",
            ownerId: "owner-1",
