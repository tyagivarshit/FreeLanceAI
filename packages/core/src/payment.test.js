...
import { Payment, Money, PAYMENT_CREATED, PAYMENT_AUTHORIZED, PAYMENT_CAPTURED, PAYMENT_COMPLETED, PAYMENT_CANCELLED, } from "./payment.js";
describe("Payment Domain Aggregate & Money Value Object Tests", () => {
    ...
    test("Monetary Policy Validation is invoked during creation", () => {
        ...
        // Valid case
        const payment = Payment.create("payment-1", "tenant-1", "client-1", "owner-1", usd100, "ref-1", customPolicy);
        assert.ok(payment);
