...
import { Repository, RepositoryMetadata, RepositoryVisibility, REPOSITORY_REGISTERED, REPOSITORY_UPDATED, REPOSITORY_AVAILABLE, REPOSITORY_ARCHIVED, REPOSITORY_REMOVED, } from "./repository.js";
describe("Repository Domain Aggregate Tests", () => {
    ...
    test("Repository creation success: status Pending and REPOSITORY_REGISTERED event emitted", () => {
        const repository = Repository.create("repo-1", "project-1", "owner-1", "ref-repo-1", validMetadata, validVisibility);
