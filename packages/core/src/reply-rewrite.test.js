...
import { RewriteInstruction, RewriteRequest, RewriteResult, ReplyRewrite, REPLY_REWRITE_DRAFTED, REPLY_REWRITE_REQUESTED, REPLY_REWRITE_COMPLETED, REPLY_REWRITE_ARCHIVED, } from "./reply-rewrite.js";
describe("Chapter 7B — Reply Studio / Rewrite Domain Tests", () => {
    ...
    describe("Persistence Interfaces Compile Checks", () => {
        test("signatures matching check", () => {
            ...
            const dummyContract = {
                async checkUniqueReference(_ownerId, _reference, _excludeRewriteId) {
                    return true;
                },
            };
