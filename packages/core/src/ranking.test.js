...
import { RankingCriteria, RankingPolicy, RankingScore, RankingCandidate, RankingResult, RankingRequest, RankingService, } from "./ranking.js";
describe("Ranking Domain and Boundary Tests", () => {
    ...
    test("Ranking policy validation and immutability", () => {
        ...
        assert.throws(() => {
            policy.criteriaSequence.push(criteriaRecency);
        }, TypeError);
    });
