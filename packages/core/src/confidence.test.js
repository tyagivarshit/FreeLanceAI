...
import { ConfidenceScore, ConfidenceLevel, ConfidenceReason, ConfidenceEvidence, ConfidenceAssessment, ConfidenceAssessedEvent, } from "./confidence.js";
describe("Confidence Domain and Boundary Tests", () => {
    ...
    test("Confidence determinism: identical properties yield identical assessments", () => {
        ...
        const score = new ConfidenceScore(0.85);
        const level = new ConfidenceLevel("High");
        const makeAssess = () => new ConfidenceAssessment({
            assessmentId: "assess-1",
            evaluationId: "eval-1",
            extractionId: "ext-1",
            score,
