import { pgTable, varchar, timestamp, pgEnum, uuid, index, jsonb, foreignKey, bigserial, } from "drizzle-orm/pg-core";
...
export const clientTimelines = pgTable("client_timelines", {
...
export const timelineEntries = pgTable("timeline_entries", {
    ...
    return {
        ...
        timelineTimestampIdx: index("timeline_entries_timeline_timestamp_idx").on(table.timelineId, table.timestamp),
    };
});
