...
export const importStatusEnum = ["PENDING", "PROCESSING", "COMPLETED", "FAILED"];
export const conversationImports = pgTable("conversation_imports", {
    ...primaryKeyColumn(),
    ...tenantIdColumn,
    ...
    tenantSourceRefIdx: uniqueIndex("idx_tenant_source_ref").on(table.tenantId, table.sourceProvider, table.externalReferenceId),
}));
