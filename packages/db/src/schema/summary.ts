...
export const clientSummaries = pgTable(
  "client_summaries",
  {
    ...primaryKeyColumn(),
    ...tenantIdColumn,
...
export const clientSummarySnapshots = pgTable(
  "client_summary_snapshots",
  {
    ...primaryKeyColumn(),
    ...tenantIdColumn,
...
export type ClientSummaryRow = typeof clientSummaries.$inferSelect;
export type ClientSummaryInsert = typeof clientSummaries.$inferInsert;
export type ClientSummarySnapshotRow = typeof clientSummarySnapshots.$inferSelect;
export type ClientSummarySnapshotInsert = typeof clientSummarySnapshots.$inferInsert;
