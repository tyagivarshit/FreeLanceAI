...
export const clientProjectPricingEstimates = pgTable("client_project_pricing_estimates", {
    ...primaryKeyColumn(),
    ...
    pricingEstimatesTenantClientUnique: unique("pricing_estimates_tenant_client_unique").on(table.tenantId, table.clientId),
}));
