...
export const clientEmbeddings = pgTable(
  "client_embeddings",
  {
  ...
  (table) => {
    return {
      ...
      resourceIdx: index("client_embeddings_resource_idx").on(
        table.tenantId,
        table.clientId,
        table.resourceType,
        table.resourceId
...
export type ClientEmbeddingRow = typeof clientEmbeddings.$inferSelect;
export type ClientEmbeddingInsert = typeof clientEmbeddings.$inferInsert;
...
export type JobEmbeddingRow = typeof jobEmbeddings.$inferSelect;
export type JobEmbeddingInsert = typeof jobEmbeddings.$inferInsert;
