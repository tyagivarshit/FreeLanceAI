import { pgTable, varchar, pgEnum, uuid, uniqueIndex, index, jsonb, foreignKey, } from "drizzle-orm/pg-core";
...
export const jobMatches = pgTable("job_matches", {
    ...
    return {
        ...
        matchingIdentityIdx: uniqueIndex("job_matches_matching_identity_unique_idx").on(table.tenantId, table.freelancerId, table.jobId, table.matchingVersion),
