import { pgTable, varchar, timestamp, text, pgEnum, uuid, uniqueIndex, index, jsonb, unique, foreignKey, } from "drizzle-orm/pg-core";
...
export const jobImports = pgTable("job_imports", {
    ...
    return {
        ...
        tenantSourceExternalIdx: uniqueIndex("job_imports_tenant_source_external_unique_idx").on(table.tenantId, table.source, table.externalJobId),
        ...
        tenantCreatedAtIdx: index("job_imports_tenant_created_at_idx").on(table.tenantId, table.createdAt),
