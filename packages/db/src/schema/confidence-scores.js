...
export const clientScopeConfidenceScores = pgTable("client_scope_confidence_scores", {
    ...primaryKeyColumn(),
    ...
    confidenceScoresTenantClientUnique: unique("confidence_scores_tenant_client_unique").on(table.tenantId, table.clientId),
}));
