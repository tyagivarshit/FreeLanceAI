...
export const bidLedgerEntries = pgTable(
  ...
  (table) => ({
    ...
    bidLedgerConcurrencyGuard: uniqueIndex("bid_ledger_concurrency_guard_idx").on(
      table.tenantId,
      table.bidId,
...
export type BidLedgerEntryRow = typeof bidLedgerEntries.$inferSelect;
export type BidLedgerEntryInsert = typeof bidLedgerEntries.$inferInsert;
