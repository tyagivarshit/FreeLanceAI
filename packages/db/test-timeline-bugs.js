...
test("Timeline Bug 1, 2, 4 Tests", async () => {
    ...
    const client = Client.create(clientId, tenantId, user1, { name: "Timeline Test Client" }, { currency: "USD", taxRegistrationId: "TAX_TL_1", billingAddress: { street: "1", city: "NY", state: "NY", postalCode: "1", country: "US" } }, { firstName: "John", lastName: "Doe", email: "timeline@client.com" });
    ...
    const client2 = Client.create(uuidv4(), tenantId, user2, { name: "Tx Test Client" }, { currency: "USD", taxRegistrationId: "TAX_TL_2", billingAddress: { street: "1", city: "NY", state: "NY", postalCode: "1", country: "US" } }, { firstName: "Jane", lastName: "Doe", email: "tx@client.com" });
