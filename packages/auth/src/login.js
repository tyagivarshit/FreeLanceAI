...
export class AccountLockedError extends LoginError {
    constructor(message = "Your account is temporarily locked due to multiple failed login attempts.") {
...
export function getFailedAttemptsMapForTesting() {
...
export async function loginUser(input) {
    ...
    try {
        ...
        const passwordMatch = await verifyPassword(password, credentials.passwordHash, credentials.algorithm, credentials.hashVersion);
