 ...
 */
export async function bufferSessionActivity(sessionId: string): Promise<void> {
 ...
 */
export async function flushSessionActivities(): Promise<number> {
  ...
  const activities = results[0][1] as Record<string, string>;
