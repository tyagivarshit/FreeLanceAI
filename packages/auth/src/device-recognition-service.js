 ...
 */
export function parseUserAgent(userAgent, ipAddress) {
...
export class DeviceRecognitionService {
    async evaluateDevice(userId, input) {
        ...
        const isRecognizedDevice = historicalSessions.length === 0 ||
            historicalSessions.some((s) => s.platform === (parsed.platform || null) && s.browser === (parsed.browser || null));
