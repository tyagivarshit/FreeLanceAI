...
import { IDBQueue } from "./indexeddb.js";
/**
...
export class EdgeResilienceSyncEngine {
    isProcessing = false;
    initialized = false;
    queue = new IDBQueue('freelanceos_offline_sync', 'sync_queue');
    ...
    async executePayloadWithContextLock(payload) {
