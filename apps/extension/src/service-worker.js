 ...
 */
async function executeApiRequest(apiPath, init, snapshotId = "dashboard-jobs") {
...
dispatcher.registerHandler("GET_JOB_DETAILS", async (payload) => {
    const data = payload;
    return executeApiRequest(`/api/jobs/${data.jobId}`);
});
dispatcher.registerHandler("RETRY_MATCH", async (payload) => {
