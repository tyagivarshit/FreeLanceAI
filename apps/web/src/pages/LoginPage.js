...
export const LoginPage = () => {
    ...
    return (<AuthLayout title="Welcome back" subtitle="Log in to your FreelanceOS workspace">
      {/* Verification Success Banner */}
      {verificationSuccess && (<div id="verification-success-banner" style={{
      ...
      {errors.length > 0 && (<div id="error-alert" className="error-alert" role="region" aria-live="assertive" aria-label="Error details">
      ...
      {/* Success Panel */}
      {successUser ? (<div id="success-panel" className="success-panel" role="region" aria-live="polite">
        ...
        <form id="login-form" onSubmit={handleSubmit} noValidate>
          <div className="form-group">
            ...
            <input type="email" id="email" placeholder="name@company.com" required autoComplete="email" aria-required="true" value={email} onChange={(e) => setEmail(e.target.value)} disabled={loading}/>
          </div>

          <div className="form-group">
            <label htmlFor="password">Password</label>
            <input type="password" id="password" placeholder="••••••••••••" required autoComplete="current-password" aria-required="true" value={password} onChange={(e) => setPassword(e.target.value)} disabled={loading}/>
          </div>
