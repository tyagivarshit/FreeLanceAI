import { db, users, clients } from "./packages/db/src/index.js";
...
async function run() {
    ...
    const proj1 = Project.create(randomUUID(), tenant1Id, client1Id, tenant1Id, "REF-123", new ProjectMetadata({ title: "T1 Project", description: "Desc" }), new ProjectVisibility("Confidential"));
    ...
    const proj2 = Project.create(randomUUID(), tenant1Id, client1Id, tenant1Id, "REF-123", // Duplicate ref
    new ProjectMetadata({ title: "T1 Project Dup", description: "Desc" }), new ProjectVisibility("Confidential"));
    try {
